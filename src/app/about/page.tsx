...
export default function Projects() {
    return (
        <div className="my-24">
            <section className="grid-cols-2 gap-6">
                ...
                <Text className="col-span-2">
                    ...
                    <br />
                    With over three years of hands-on experience, I have successfully delivered robust and scalable solutions across diverse projects. My skill set also encompasses mobile application development using React Native and Swift, enabling the creation of exceptional and user-friendly mobile applications.
                    <br />
            ...
            <section className="flex flex-col col-span-2">
                <div className="mt-12 col-span-2 mb-12">
                    <HeadingThree>
                        My Experiences
                    </HeadingThree>
                </div>
